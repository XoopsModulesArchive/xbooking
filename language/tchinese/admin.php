...
define("_MA_SAVE","儲存");
define("_MA_ADMIN_BOOKING_SUBMIT","送出查詢");
...
define("_MA_KIMOZIJACANA_O_BOOKING_DATE","參觀日期");
define("_MA_KIMOZIJACANA_O_PERIOD","預定時段");
define("_MA_KIMOZIJACANA_O_BOOKING_NUM","預定人數");
define("_MA_KIMOZIJACANA_O_ORGANIZATION","預約單位");
...
define("_MA_ORGANIZATION_TITLE","水雉復育園區");
define("_MA_ORGANIZATION_ADMIN","管理員");
define("_MA_ORGANIZATION_DIV_TITLE","特定日期時段『禁止預約』設定");
define("_MA_KIMOZIJACANA_O_OK_NO","否");
define("_MA_KIMOZIJACANA_O_OK_YES","是");
define("_MA_SHOW_ADMIN_ATTENTION_WORKER","進階使用說明");
define("_MA_ADMIN_BOOKING_ATTENTION","
<p>★　首次使用請先設定『預設時段/人數』。</p>
<p>★　『預設時段/人數』沒有『刪除』功能，避免產生錯誤。日後如有『編輯』時段/人數，已產生的預約單，將對應到新的設定。</p>
<p>★　管理員想要預約，在已開放『可預約日』建議管理員循流程來新增預約；而非開放日期，才使用『新增』的功能。</p>
<p>★　使用『編輯』功能修改預約單，請留意當日限額，系統並不會檢查喔！而是賦予管理員至高無上的權力！</p>
");
